...
namespace deteksiwajah
{
    public partial class DeteksiWajah : Form
    {
        ...
        //deklarasi penggunaan kelas viola-jones untuk mendeteksi gambar 
        private HaarCascade haar;
        private HaarCascade haarmata;
        ...
        private void MendeteksiWajah()
        {
            ...
            Image<Gray, byte> framegrayscale = FrameGambar.Convert<Gray, byte>();
            //mendeteksi wajah dari gray-scale image dan menyimpan ke dalam array wajah
            var wajah = framegrayscale.DetectHaarCascade(haar, 1.1, 2,HAAR_DETECTION_TYPE.DO_CANNY_PRUNING,new Size(25, 25))[0];
            //var mata = framegrayscale.DetectHaarCascade(haarmata, 1.1, 2, HAAR_DETECTION_TYPE.DO_CANNY_PRUNING, new Size(20, 20))[0];
            if (wajah.Length > 0)
            {
                ...
                var mata = framegrayscale.DetectHaarCascade(haarmata, 1.1, 2, HAAR_DETECTION_TYPE.DO_CANNY_PRUNING, new Size(25, 25))[0];
                foreach (var mata2 in mata)
                {
                    FrameGambar.Draw(mata2.rect, new Bgr(Color.Coral), 3);
                }
                ...
                //menampilkan notifikasi yang tidak terdeteksi wajah
                MessageBox.Show("Wajah tidak terdeteksi");
        }
        ...
        private void DeteksiWajah_Load(object sender, EventArgs e)
        {
            ...
            haarmata = new HaarCascade("haarcascade_eye.xml");
        }
