...
namespace deteksiwajah
{
    public partial class DeteksiWajah : Form
    {
        ...
        private void ProsesMenangkapFrame(object sender, EventArgs arg)
        {
            ...
            decimal startTimeDouble = Convert.ToDecimal(DateTime.Now.ToOADate());
            decimal mili;
            decimal fps=0.001M;
            ...
            decimal endTimeDouble = Convert.ToDecimal(endTime.ToOADate());
            txtMiliSecond.Text = (endTimeDouble - startTimeDouble).ToString();
            mili = Convert.ToDecimal(txtMiliSecond.Text);
            txtFPS.Text=(fps/mili).ToString();
        }
